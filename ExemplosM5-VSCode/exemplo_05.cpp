...
int main()
{
	...
	l0->ratey = 0;
	layers.push_back(l0);
	loadTexture(l0->tid, l0->filename.c_str());
	...
	l1->ratey = 0;
	layers.push_back(l1);
	loadTexture(l1->tid, l1->filename.c_str());
	...
	layers.push_back(l2);
	loadTexture(l2->tid, l2->filename.c_str());
	...
	l3->ratey = 0;
	layers.push_back(l3);
	loadTexture(l3->tid, l3->filename.c_str());
	...
	l4->ratey = 0;
	layers.push_back(l4);
	loadTexture(l4->tid, l4->filename.c_str());
